...
const AddSubcategoryDialog = ({ open, onOpenChange, category, onAdd }: AddSubcategoryDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Adicione uma subcategoria para a categoria <strong>{category.nome}</strong>
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="subcategoria-descricao">Descrição</Label>
              <Textarea
            ...
            <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
              <div className="space-y-0.5">
                <Label htmlFor="subcategoria-ativo">Subcategoria ativa</Label>
