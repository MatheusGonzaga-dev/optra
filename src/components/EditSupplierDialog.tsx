...
const EditSupplierDialog = ({ open, onOpenChange, supplier, onEdit }: EditSupplierDialogProps) => {
  ...
  const buscarDadosCNPJ = async (cnpj: string) => {
    ...
    try {
      ...
      // Se ainda não funcionou, tenta API Brasil (gratuita)
      if (!data) {
        try {
      ...
      <DialogContent className="sm:max-w-[1000px] max-h-[95vh] overflow-y-auto">
        <DialogHeader className="border-b pb-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <DialogTitle className="text-3xl font-bold">Editar Fornecedor</DialogTitle>
